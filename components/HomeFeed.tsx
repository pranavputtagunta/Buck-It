...
const MOCK_EVENTS: EventItem[] = [
  {
    id: '1',
    user: 'Alex',
    locationName: 'Torrey Pines Reserve',
  ...
  },
  {
    id: '2',
    user: 'Sam',
    locationName: 'Mission Bay Rentals',
...
const MOCK_POSTS: PostItem[] = [
  {
    ...
    caption:
      'Finally checked snorkeling off the list! The sea lions were incredible. 🦭🌊',
    image:
      'https://images.unsplash.com/photo-1544552866-d3ed42536fcb?q=80&w=800&auto=format&fit=crop',
    likes: 124,
  },
  {
    id: '102',
    ...
    caption:
      'Weekend bouldering trip was a success. Hands are destroyed but worth it.',
    image:
      ...
      <View style={styles.cardHeader}>
        ...
        >
          ...
          {expandedMapId === item.id ? (
            <ChevronUp color="#888" size={14} style={{ marginLeft: 2 }} />
          ) : (
            <ChevronDown color="#888" size={14} style={{ marginLeft: 2 }} />
          )}
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerIcons}>
            {feedType === 'Events' && (
              ...
              >
                <Filter
                  color={activeFilterIds.length > 0 ? '#318bfb' : '#000'}
                  size={26}
                />
                {activeFilterIds.length > 0 && (
            ...
            <View>
              ...
              <View style={styles.switcherContainer}>
                <TouchableOpacity
                  style={[
                    styles.switcherTab,
                    feedType === 'Events' && styles.switcherTabActive,
                  ]}
                  onPress={() => setFeedType('Events')}
                >
                  <Text
                    style={[
                      styles.switcherText,
                      feedType === 'Events' && styles.switcherTextActive,
                    ]}
                  >
                    Events
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.switcherTab,
                    feedType === 'Posts' && styles.switcherTabActive,
                  ]}
                  onPress={() => setFeedType('Posts')}
                >
                  <Text
                    style={[
                      styles.switcherText,
                      feedType === 'Posts' && styles.switcherTextActive,
                    ]}
                  >
                    Scrapbook
                  </Text>
