...
const Field = ({
  icon, value, onChangeText, placeholder, multiline,
}: {
...
export default function ProfileStep({
  personality, hobbiesInput, location,
  onChangePersonality, onChangeHobbiesInput, onChangeLocation,
  onContinue,
}: any) {
...
const styles = StyleSheet.create({
  ...
  inputWrap: {
    ...
    paddingHorizontal: 14, marginBottom: 12, minHeight: 52,
  },
  inputWrapTall: { alignItems: 'flex-start', paddingTop: 14, minHeight: 100 },
  inputIcon: { marginRight: 10, marginTop: 2 },
  input:     { flex: 1, fontSize: 15, color: C.textPrimary, fontWeight: '400', paddingVertical: 0 },
